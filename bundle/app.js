...
var main = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var API_KEY, BASE_URL, LEVEL_PROGRESSION, RECENT_UNLOCK, KANJI, progressionData, recentUnlockData, kanjiData, recentKanji;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        API_KEY = 'be20a1b36b3a4ac78710b08becc7537e';
                        BASE_URL = 'https://www.wanikani.com/api/user/' + API_KEY + '/';
                        LEVEL_PROGRESSION = BASE_URL + 'level-progression';
                        RECENT_UNLOCK = BASE_URL + 'recent-unlocks/1';
                        KANJI = BASE_URL + 'kanji';
                        progressionData = void 0, recentUnlockData = void 0, kanjiData = void 0;
                        _context2.next = 8;
                        return fetchAsync(LEVEL_PROGRESSION).then(function (data) {
                            return progressionData = data;
                    ...
                    case 8:
                        _context2.next = 10;
                        return fetchAsync(RECENT_UNLOCK).then(function (data) {
                            return recentUnlockData = data;
                        }).catch(function (reason) {
                            return console.log(reason);
                        });
                    ...
                    case 10:
                        _context2.next = 12;
                        return fetchAsync(KANJI).then(function (data) {
                    ...
                    case 12:
                        ...
                        recentKanji = recentUnlockData.requested_information[0];
